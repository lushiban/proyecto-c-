...
const configuracionTipos = {
    Oyente: {
        etiqueta: 'Canción favorita',
        placeholder: 'Ej. Golden',
        detalle: 'Canción favorita',
        icono: '♪'
    },
    Artista: {
        etiqueta: 'Instrumento favorito',
        placeholder: 'Ej. Guitarra eléctrica',
        detalle: 'Instrumento favorito',
        icono: '♬'
    },
    Productor: {
        etiqueta: 'Programa favorito',
        placeholder: 'Ej. Ableton Live',
        detalle: 'Programa favorito',
        icono: '◉'
    },
    FanClub: {
        etiqueta: 'Artista o grupo favorito',
        placeholder: 'Ej. The Marías',
        detalle: 'Artista favorito',
        icono: '♥'
    }
};
...
const elementos = {
    ...
    specialFieldLabel: document.querySelector('#specialFieldLabel'),
    specialFieldInput: document.querySelector('#specialFieldInput'),
...
function actualizarCampoEspecial() {
    const configuracion = configuracionTipos[elementos.profileType.value] ?? configuracionTipos.Oyente;
    elementos.specialFieldLabel.textContent = configuracion.etiqueta;
    elementos.specialFieldInput.placeholder = configuracion.placeholder;
}
...
function registrarEventos() {
    ...
    elementos.profileType.addEventListener('change', actualizarCampoEspecial);
