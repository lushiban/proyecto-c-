...
RedSocialMusical::RedSocialMusical()
...
void RedSocialMusical::intercambiar(RedSocialMusical& otra) noexcept {
...
void RedSocialMusical::redimensionarPerfiles() {
...
void RedSocialMusical::redimensionarConexiones() {
...
void RedSocialMusical::agregarPerfil(Perfil* perfil) {
...
void RedSocialMusical::agregarConexion(Conexion* conexion) {
...
void RedSocialMusical::eliminarConexionesDePerfil(int perfilId) noexcept {
...
int RedSocialMusical::calcularAfinidadEntrePerfiles(
...
int RedSocialMusical::crearPerfilOyente(
    std::string nombre,
    int edad,
...
int RedSocialMusical::crearPerfilArtista(
    std::string nombre,
    int edad,
    std::string generoPrincipal,
    std::vector<std::string> generosSecundarios,
...
int RedSocialMusical::crearPerfilProductor(
    std::string nombre,
    int edad,
    std::string generoPrincipal,
    std::vector<std::string> generosSecundarios,
...
int RedSocialMusical::crearPerfilFanClub(
    std::string nombre,
    int edad,
    std::string generoPrincipal,
    std::vector<std::string> generosSecundarios,
...
const Perfil* RedSocialMusical::buscarPerfil(int id) const noexcept {
    for (std::size_t i = 0; i < cantidadPerfiles_; i++) {
...
bool RedSocialMusical::eliminarPerfil(int id) noexcept {
    for (std::size_t i = 0; i < cantidadPerfiles_; i++) {
        if (perfiles_[i]->obtenerId() == id) {
...
int RedSocialMusical::calcularAfinidad(
    int perfilAId,
    int perfilBId
) const noexcept {
...
std::vector<PerfilCompatible> RedSocialMusical::buscarPerfilesCompatibles(
    int perfilId
) const {
...
ResultadoConexion RedSocialMusical::crearConexion(
    int perfilAId,
    int perfilBId
) {
    const Perfil* perfilA = buscarPerfil(perfilAId);
...
bool RedSocialMusical::existeConexion(
    int perfilAId,
    int perfilBId
) const noexcept {
    for (std::size_t i = 0; i < cantidadConexiones_; i++) {
...
bool RedSocialMusical::eliminarConexion(
    int perfilAId,
    int perfilBId
) noexcept {
    for (std::size_t i = 0; i < cantidadConexiones_; i++) {
...
std::size_t RedSocialMusical::obtenerCantidadPerfiles() const noexcept {
    return cantidadPerfiles_;
}

std::size_t RedSocialMusical::obtenerCapacidadPerfiles() const noexcept {
    return capacidadPerfiles_;
}

int RedSocialMusical::obtenerSiguientePerfilId() const noexcept {
    return siguientePerfilId_;
}

const Perfil* RedSocialMusical::obtenerPerfilEn(
    std::size_t posicion
) const noexcept {
...
std::size_t RedSocialMusical::obtenerCantidadConexiones() const noexcept {
    return cantidadConexiones_;
}

std::size_t RedSocialMusical::obtenerCapacidadConexiones() const noexcept {
    return capacidadConexiones_;
}

const Conexion* RedSocialMusical::obtenerConexionEn(
    std::size_t posicion
) const noexcept {
